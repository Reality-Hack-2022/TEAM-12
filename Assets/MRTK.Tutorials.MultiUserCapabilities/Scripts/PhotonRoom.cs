...
namespace MRTK.Tutorials.MultiUserCapabilities
{
    public class PhotonRoom : MonoBehaviourPunCallbacks, IInRoomCallbacks
    {
        ...
        [SerializeField] private GameObject EnjoymentPrefab = default;

        [SerializeField] private GameObject ZonePrefab = default;
        [SerializeField] private GameObject FocusPrefab = default;
        [SerializeField] private GameObject HeartPrefab = default;


        [SerializeField] private GameObject EnjoyZonePrefab = default;

        [SerializeField] private GameObject FocusZonePrefab = default;

        [SerializeField] private GameObject HeartZonePrefab = default;
        ...
        private void Start()
        {
            ...
            if (PhotonNetwork.PrefabPool is DefaultPool pool)
            {
                ...
                if (EnjoymentPrefab != null) pool.ResourceCache.Add(EnjoymentPrefab.name, EnjoymentPrefab);
                if (ZonePrefab != null) pool.ResourceCache.Add(ZonePrefab.name, ZonePrefab);
                if (FocusPrefab != null) pool.ResourceCache.Add(FocusPrefab.name, FocusPrefab);
                if (HeartPrefab != null) pool.ResourceCache.Add(HeartPrefab.name, HeartPrefab);

                if (EnjoyZonePrefab != null) pool.ResourceCache.Add(EnjoyZonePrefab.name, EnjoyZonePrefab);
                if (FocusZonePrefab != null) pool.ResourceCache.Add(FocusZonePrefab.name, FocusZonePrefab);
                if (HeartZonePrefab != null) pool.ResourceCache.Add(HeartZonePrefab.name, HeartZonePrefab);
            }
        }
